...
Typed insert + lookup helpers for BP-ENTRY-COMMITMENT-PRE-GRANT-V1 entries
...
// commitment_split_id table for BP-ENTRY-COMMITMENT-PRE-GRANT-V1 entries.
//
...
// supplied splitID for the BP-ENTRY-COMMITMENT-PRE-GRANT-V1 schema.
//
