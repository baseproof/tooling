...
KEY DEPENDENCIES:
  - github.com/baseproof/baseproof/did: DIDEndpointAdapter.
  - github.com/baseproof/tooling/services/ledger/tessera: TileReader.
...
// BaseproofLedger service entry. Returns the empty string if the
...
// BaseproofArtifactStore service entry.
...
// TestAuditor_AccessorSurface is gated on BASEPROOF_TEST_DSN. Boots a
