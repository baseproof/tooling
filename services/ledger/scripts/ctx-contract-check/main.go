...
const (
	sdkPathPrefix    = "github.com/baseproof/baseproof/"
	ledgerPathPrefix = "github.com/baseproof/tooling/services/ledger"
)
...
func run() (exitCode int) {
	...
	sdkVersion := flag.String("sdk-version", "",
		"optional: published baseproof SDK version to test against (e.g. v0.2.0). "+
			"The tool runs `go get github.com/baseproof/baseproof@<v>` to "+
	...
	// go.mod / go.sum, run `go get baseproof@<v>`, install a deferred
...
// `go get github.com/baseproof/baseproof@<version>` to bump the
...
const sdkModulePath = "github.com/baseproof/baseproof"
...
func trimPkgPath(p string) string {
	return strings.TrimPrefix(p, "github.com/baseproof/")
}
