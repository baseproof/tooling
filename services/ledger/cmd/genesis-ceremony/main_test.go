...
func TestBuildBootstrapDoc_PassesGenesisValidation(t *testing.T) {
	...
	for _, gating := range []string{"off", "require"} {
		doc := buildBootstrapDoc("did:web:state:tn:davidson", "clarity-test", gating, "require", []string{did}, 1, addr, 1, nil, "", nil)
...
func TestBuildBootstrapDoc_MinSignaturesConfigurable(t *testing.T) {
	...
	doc := buildBootstrapDoc("did:web:state:tn:davidson", "clarity-test", "require", "require", []string{did}, 1, addr, 3, nil, "", nil)
	...
	zero := buildBootstrapDoc("did:web:state:tn:davidson", "clarity-test", "require", "require", []string{did}, 1, addr, 0, nil, "", nil)
...
func TestInitNetwork_EmitsConstitutionalK(t *testing.T) {
	...
	doc := buildBootstrapDoc("did:web:state:tn:davidson", "clarity-test", "require", "require", dids, k, addr, 1, nil, "", nil)
...
func TestMintServedBootstrap_RequireSelfEndorses(t *testing.T) {
	...
	doc := buildBootstrapDoc("did:web:state:tn:davidson", "clarity-test", "require", "require", dids, 2, addr, 1, nil, "", nil)
	ids, err := doc.IDs()
	if err != nil {
		t.Fatalf("IDs: %v", err)
	}
...
func TestMintServedBootstrap_OffPolicy(t *testing.T) {
	...
	doc := buildBootstrapDoc("did:web:state:tn:davidson", "clarity-test", "require", "off", dids, 2, addr, 1, nil, "", nil)
	ids, err := doc.IDs()
	if err != nil {
		t.Fatalf("IDs: %v", err)
	}
...
func TestEndorsementPolicy_BoundIntoNetworkID(t *testing.T) {
	...
	reqDoc := buildBootstrapDoc("did:web:state:tn:davidson", "clarity-test", "require", "require", dids, 2, addr, 1, nil, "", nil)
	offDoc := buildBootstrapDoc("did:web:state:tn:davidson", "clarity-test", "require", "off", dids, 2, addr, 1, nil, "", nil)
