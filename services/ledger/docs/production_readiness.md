...
- **Phase 1 evidence (this branch):** `cmd/rebuild-projection/`
  ...
  BASEPROOF_TEST_DSN) appends 50 entries through upstream Tessera,
...
### C3 — Jellyfish/Patricia SMT for 10⁹+ scale 🟢 (shipped, baseproof v0.3.0)
- **Today:** SMT root is maintained incrementally via the SDK's
  Jellyfish/Patricia trie (`baseproof v0.3.0`). The builder loop
...
- **EVIDENCE — SDK-level scaling tests (baseproof `core/smt/jellyfish_scaling_test.go`,
  measured at N=1024):**
