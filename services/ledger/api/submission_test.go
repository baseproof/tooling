...
func TestDeductCreditModeA_UnauthenticatedReturnsNil(t *testing.T) {
	if err := deductCreditModeA(context.Background(), &SubmissionDeps{}, false, "", 1); err != nil {
...
func TestDeductCreditModeA_NilStoresReturnNil(t *testing.T) {
	...
	if err := deductCreditModeA(context.Background(), deps, true, "did:test:exchange", 1); err != nil {
