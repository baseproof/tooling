...
func TestInstallCounters_AllFiveSurfaceTheRightAtomics(t *testing.T) {
	...
	cases := []struct {
		...
		{"baseproof_shipper_shipped_total", 11},
		{"baseproof_shipper_shipped_unique_total", 7},
		{"baseproof_shipper_skipped_inflight_total", 13},
		{"baseproof_shipper_retries_total", 3},
		{"baseproof_shipper_mark_failures_total", 2},
	}
