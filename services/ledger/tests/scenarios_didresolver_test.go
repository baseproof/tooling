...
KEY ARCHITECTURAL DECISIONS:
  ...
  - Documents follow the SDK's DIDDocument layout exactly, including
    the Baseproof extensions (witness_endpoints / ledger_endpoint /
...
KEY DEPENDENCIES:
  - github.com/baseproof/baseproof/did: DIDResolver, DIDDocument,
...
type endpointBundle struct {
	LedgerURL      string   // "BaseproofLedgerEndpoint" service entry.
	CDNURL         string   // "BaseproofArtifactStore" service entry.
	WitnessURLs    []string // "BaseproofWitnessEndpoint" service entries.
