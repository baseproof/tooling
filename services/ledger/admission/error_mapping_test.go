...
func TestSDKErrorTable_EveryGateRepresented(t *testing.T) {
	...
	mustBeMapped := []error{
		...
		ErrSignatureAlgoNotAllowed,     // II.6 SignaturePolicy allow-list
		ErrSignaturePolicyFailed,       // II.6 SignaturePolicy threshold
		ErrModeBProofRequired,          // Post-II #3 Mode-B PoW shape
		ErrModeBStampInvalid,           // Post-II #3 Mode-B PoW verify
	}
