...
type STHPublisher struct {
	...
	// `baseproof_checkpoint_cosig_age_seconds` gauge consumed by
...
func (p *STHPublisher) PublishCosignedHead(ctx context.Context, head types.CosignedTreeHead) {
	...
	// `baseproof_checkpoint_cosig_age_seconds` freshness gauge.
...
// `baseproof_checkpoint_cosig_age_seconds` gauge consumed by SRE
// dashboards.
